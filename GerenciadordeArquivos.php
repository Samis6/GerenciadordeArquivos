...
/**
 * H3K | Gerenciador de Arquivos | agn6 V2.5.3
...
//Application Title
define('APP_TITLE', 'Gerenciador de Arquivos | agn6');
...
$allowed_upload_extensions = 'gif,png,jpg,pdf';
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="mb-3">
                                       <div class="brand">
                                            <img src="" alt="Logo" style="max-width: 100%; max-height: 100%; object-fit: contain;">
                                        </div>
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://tinyfilemanager.github.io/" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">Amplifica Digital</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
...
if ((isset($_SESSION[FM_SESSION_ID]['logged'], $auth_users[$_SESSION[FM_SESSION_ID]['logged']]) || !FM_USE_AUTH) && isset($_POST['ajax'], $_POST['token']) && !FM_READONLY) {
    ...
    // Save Config         global $cfg, $lang, $report_errors, $show_hidden_files, $lang_list, $hide_Cols, $theme;
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title"> Gerenciador de Arquivos | agn6 <?php echo VERSION; ?></a></h3></p>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">Gerenciador de Arquivos | agn6 <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">Gerenciador de Arquivos | agn6 <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'Gerenciador de Arquivos | agn6<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily with Gerenciador de Arquivos | agn6">
    <meta name="author" content="Amplifica Digital">
    ...
    background-image: url("");
        ...
        .fm-login-page .brand{ width:200px;padding:40px 10px;overflow:hidden;margin:0 auto;position:relative;z-index:1}
...
<head>
    ...
    <style>
        ...
        html { -moz-osx-font-smoothing: grayscale; -webkit-font-smoothing: antialiased; text-rendering: optimizeLegibility; height: 100%; scroll-behavior: smooth;background-image: url("");}
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Gerenciador de Arquivos';      $tr['en']['AppTitle']           = 'File Manager';
    ...
    // Portuguese Language
    $tr['pt']['AppName']        = 'Gerenciador de Arquivos';      $tr['pt']['AppTitle']           = 'Gerenciador de Arquivos';
    $tr['pt']['Login']          = 'Entrar';                $tr['pt']['Username']           = 'Usuário';
    $tr['pt']['Password']       = 'Senha';               $tr['pt']['Logout']             = 'Sair';
    $tr['pt']['Move']           = 'Mover';                   $tr['pt']['Copy']               = 'Copiar';
    $tr['pt']['Save']           = 'Salvar';                   $tr['pt']['SelectAll']          = 'Selecionar tudo';
    $tr['pt']['UnSelectAll']    = 'Desselecionar tudo';           $tr['pt']['File']               = 'Arquivo';
    $tr['pt']['Back']           = 'Voltar';                   $tr['pt']['Size']               = 'Tamanho';
    $tr['pt']['Perms']          = 'Permissões';                  $tr['pt']['Modified']           = 'Modificado';
    $tr['pt']['Owner']          = 'Proprietário';                  $tr['pt']['Search']             = 'Pesquisar';
    $tr['pt']['NewItem']        = 'Novo Item';               $tr['pt']['Folder']             = 'Pasta';
    $tr['pt']['Delete']         = 'Excluir';                 $tr['pt']['Rename']             = 'Renomear';
    $tr['pt']['CopyTo']         = 'Copiar para';                $tr['pt']['DirectLink']         = 'Link direto';
    $tr['pt']['UploadingFiles'] = 'Carregando arquivos';           $tr['pt']['ChangePermissions']  = 'Alterar permissões';
    $tr['pt']['Copying']        = 'Copiando';                $tr['pt']['CreateNewItem']      = 'Criar Novo Item';
    $tr['pt']['Name']           = 'Nome';                   $tr['pt']['AdvancedEditor']     = 'Editor Avançado';
    $tr['pt']['Actions']        = 'Ações';                $tr['pt']['Folder is empty']    = 'A pasta está vazia';
    $tr['pt']['Upload']         = 'Carregar';                 $tr['pt']['Cancel']             = 'Cancelar';
    $tr['pt']['InvertSelection']= 'Inverter Seleção';       $tr['pt']['DestinationFolder']  = 'Pasta de Destino';
    $tr['pt']['ItemType']       = 'Tipo de Item';              $tr['pt']['ItemName']           = 'Nome do Item';
    $tr['pt']['CreateNow']      = 'Criar Agora';             $tr['pt']['Download']           = 'Baixar';
    $tr['pt']['Open']           = 'Abrir';                   $tr['pt']['UnZip']              = 'Descompactar';
    $tr['pt']['UnZipToFolder']  = 'Descompactar para a pasta';        $tr['pt']['Edit']               = 'Editar';
    $tr['pt']['NormalEditor']   = 'Editor Normal';          $tr['pt']['BackUp']             = 'Backup';
    $tr['pt']['SourceFolder']   = 'Pasta de Origem';          $tr['pt']['Files']              = 'Arquivos';
    $tr['pt']['Move']           = 'Mover';                   $tr['pt']['Change']             = 'Mudar';
    $tr['pt']['Settings']       = 'Configurações';               $tr['pt']['Language']           = 'Idioma';        
    $tr['pt']['ErrorReporting'] = 'Relatório de Erros';        $tr['pt']['ShowHiddenFiles']    = 'Mostrar Arquivos Ocultos';
    $tr['pt']['Help']           = 'Ajuda';                   $tr['pt']['Created']            = 'Criado';
    $tr['pt']['Help Documents'] = 'Documentos de Ajuda';         $tr['pt']['Report Issue']       = 'Reportar Problema';
    $tr['pt']['Generate']       = 'Gerar';               $tr['pt']['FullSize']           = 'Tamanho Completo';              
    $tr['pt']['HideColumns']    = 'Ocultar colunas Perms/Owner';$tr['pt']['You are logged in'] = 'Você está logado';
    $tr['pt']['Nothing selected']   = 'Nada selecionado';   $tr['pt']['Paths must be not equal']    = 'Os caminhos não devem ser iguais';
    $tr['pt']['Renamed from']       = 'Renomeado de';       $tr['pt']['Archive not unpacked']       = 'Arquivo não descompactado';
    $tr['pt']['Deleted']            = 'Excluído';            $tr['pt']['Archive not created']        = 'Arquivo não criado';
    $tr['pt']['Copied from']        = 'Copiado de';        $tr['pt']['Permissions changed']        = 'Permissões alteradas';
    $tr['pt']['to']                 = 'para';                 $tr['pt']['Saved Successfully']         = 'Salvo com sucesso';
    $tr['pt']['not found!']         = 'não encontrado!';         $tr['pt']['File Saved Successfully']    = 'Arquivo salvo com sucesso';
    $tr['pt']['Archive']            = 'Arquivo';            $tr['pt']['Permissions not changed']    = 'Permissões não alteradas';
    $tr['pt']['Select folder']      = 'Selecionar pasta';      $tr['pt']['Source path not defined']    = 'Caminho de origem não definido';
    $tr['pt']['already exists']     = 'já existe';     $tr['pt']['Error while moving from']    = 'Erro ao mover de';
    $tr['pt']['Create archive?']    = 'Criar arquivo?';    $tr['pt']['Invalid file or folder name']    = 'Nome de arquivo ou pasta inválido';
    $tr['pt']['Archive unpacked']   = 'Arquivo descompactado';   $tr['pt']['File extension is not allowed']  = 'Extensão de arquivo não permitida';
    $tr['pt']['Root path']          = 'Caminho raiz';          $tr['pt']['Error while renaming from']  = 'Erro ao renomear de';
    $tr['pt']['File not found']     = 'Arquivo não encontrado';     $tr['pt']['Error while deleting items'] = 'Erro ao excluir itens';
    $tr['pt']['Moved from']         = 'Movido de';         $tr['pt']['Generate new password hash'] = 'Gerar novo hash de senha';
    ...
    $tr['pt']['Advanced Search']    = 'Pesquisa Avançada';    $tr['pt']['Error while copying from']    = 'Erro ao copiar de';
    ...
    $tr['pt']['Selected files and folder deleted']              = 'Arquivos e pastas selecionados excluídos';
    $tr['pt']['Error while fetching archive info']              = 'Erro ao buscar informações do arquivo';
    $tr['pt']['Delete selected files and folders?']             = 'Excluir arquivos e pastas selecionados?';
    $tr['pt']['Search file in folder and subfolders...']        = 'Pesquisar arquivo na pasta e subpastas...';
    $tr['pt']['Access denied. IP restriction applicable']       = 'Acesso negado. Restrição de IP aplicável';
    $tr['pt']['Invalid characters in file or folder name']      = 'Caracteres inválidos no nome do arquivo ou pasta';
    $tr['pt']['Operations with archives are not available']     = 'Operações com arquivos não estão disponíveis';
    $tr['pt']['File or folder with this path already exists']   = 'Arquivo ou pasta com este caminho já existe';
